...
class PageVendas(ctk.CTk):
    ...
    def aba_vendas(self):
        ...
        self.tabela = ttk.Treeview(self.main_frame, columns=("ID", "Produto", "Preço", "Quantidade","Desconto", "Valor", "Data", "Cliente ID"), show="headings")
        ...
        self.tabela.heading("Cliente ID", text="ID Cliente")
