...
class Venda:
    ...
    def processar_venda(self):
        ...
        try:
            #Busca o produto para pegar ID e Preço atual
            ...
            #Aqui resgata o ID do produto e o valor unitário para realizar o cálculo da venda e atualizar o estoque.            
            #Realiza o cálculo
            if self.desconto > 0:
            ...
            #Insere na tabela de vendas (incluindo o ID do produto e valor total)
            insert_query = """ 
